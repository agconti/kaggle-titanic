...
To run this notebook interactively, download this repository by clicking on this [link](github-windows://openRepo/https://github.com/agconti/kaggle-titanic). Then open the notebook and follow along.
